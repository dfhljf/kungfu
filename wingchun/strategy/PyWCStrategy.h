...
public:
    ...
    //py log
    virtual void log_debug(string msg)
    {
        KF_LOG_DEBUG(logger, msg);
    };

    virtual void log_info(string msg)
    {
        KF_LOG_INFO(logger, msg);
    };

    virtual void log_error(string msg)
    {
        KF_LOG_ERROR(logger, msg);
    };

    virtual void log_fatal(string msg)
    {
        KF_LOG_FATAL(logger, msg);
    };
    ...
    WCStrategyUtilPtr get_strategy_util() const
    {
        return util;
    }

    WCDataWrapperPtr get_data_wrapper() const
    {
        return data;
    }
...
public:
    PyWCStrategy(const string& name)
        : IWCStrategy(name)
    {
    }
